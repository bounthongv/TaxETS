  ...
  <ul class="list-unstyled components">
    ...
    <li class="<?= $is_system ? 'active' : '' ?>">
      ...
      <ul class="collapse list-unstyled <?= $is_system ? 'show' : '' ?>" id="systemSub">
        ...
        <li class="<?= $cur == 'system_history.php' ? 'active' : '' ?>"><a href="<?= BASE_URL ?>/pages/system_history.php">User history</a></li>
        ...
        <li class="<?= $cur == 'system_logs.php' ? 'active' : '' ?>"><a href="<?= BASE_URL ?>/pages/system_logs.php">Operation Logs</a></li>
