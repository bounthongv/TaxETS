  ...
  <ul class="list-unstyled components">
    ...
    <li class="<?= $is_dict ? 'active' : '' ?>">
      ...
      <ul class="collapse list-unstyled <?= $is_dict ? 'show' : '' ?>" id="dictionarySub">
        ...
        <li class="<?= $cur == 'dictionary_payment_condition.php' ? 'active' : '' ?>"><a href="<?= BASE_URL ?>/pages/dictionary_payment_condition.php">Payment Condition Code</a></li>
      </ul>
    </li>
    ...
    <?php 
        ...
        $is_asycuda_pages = ((strpos($cur, 'asycuda_') !== false && strpos($cur, 'te_asycuda_') === false) || $cur == 'import_asycuda.php' || $cur == 'view_asycuda.php' || $cur == 'asycuda_index.php');
    ...
    <!-- TE Calculation -->
    <?php
        $is_calc = (strpos($cur, 'te_') !== false || $cur == 'calculator.php');
