...
<div class="row mb-3">
    <div class="col-12">
        <h2><a href="repo_mpi.php" class="text-dark text-decoration-none"><i class="fas fa-arrow-left me-2"></i></a> Add New MPI Project</h2>
        <p class="text-muted">Register a new investment project granted by the Ministry of Planning and Investment.</p>
    </div>
</div>
        ...
        <form action="save_mpi.php" method="POST">
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" name="project_name" class="form-control" required placeholder="Name of projects granted by MPI">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="investment_license_date" class="form-control">
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="tax_holiday_period" class="form-control" placeholder="e.g. 5 Years, 2024-2029">
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label fw-bold">Activities</label>
                <textarea name="activities" class="form-control" rows="3" placeholder="Project activities..."></textarea>
            </div>

            <div class="mb-3">
                <label class="form-label fw-bold">Incentives as outlined in the agreement signed with MPI</label>
                <textarea name="incentives" class="form-control" rows="3" placeholder="Description of incentives..."></textarea>
            </div>

            <div class="d-flex justify-content-end gap-2 mt-4">
                <a href="repo_mpi.php" class="btn btn-secondary px-4">Cancel</a>
                <button type="submit" class="btn btn-success px-5"><i class="fas fa-save me-2"></i> Save Project Record</button>
            </div>
        </form>
    </div>
</div>
