...
<div class="row mb-3">
    <div class="col-md-12">
        <h2><i class="fas fa-receipt me-2"></i> ASYCUDA Data: Import VAT</h2>
        <p class="text-muted">Common fields and Import VAT benchmark vs paid data.</p>
    </div>
</div>
            ...
            <table class="table table-hover table-sm mb-0 small text-nowrap">
                <thead class="table-light sticky-top">
                    <tr>
                        ...
                        <th>Unit</th>
                        <th>Invoice LAK</th>
                        <th class="table-primary text-center border-start">Exempt_VAT (Benchmark)</th>
                        <th class="table-success text-center border-start">VAT (Paid)</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end fw-bold text-primary border-start"><?= number_format($r['exempt_vat']) ?></td>
                        <td class="text-end fw-bold text-success border-start"><?= number_format($r['paid_vat']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if (empty($rows)): ?>
