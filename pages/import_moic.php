...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_FILES["excel_file"])) {
    ...
    try {
        ...
        for ($row = 2; $row <= $sheet->getHighestRow(); $row++) {
            ...
            $stmt = $pdo->prepare("INSERT INTO repo_moic (import_batch_id, tin, company_name, license_date) VALUES (?, ?, ?, ?)");
...
<div class="row mb-3">
    <div class="col-12">
        <h2><a href="repo_moic.php" class="text-dark"><i class="fas fa-arrow-left me-2"></i></a> Import MOIC Data</h2>
    </div>
</div>
