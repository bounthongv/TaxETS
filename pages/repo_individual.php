...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["action"])) {
    try {
        if ($_POST["action"] == "add_provision") {
            ...
            $pdo->prepare("DELETE FROM individual_provisions WHERE id = ?")->execute([$_POST["id"]]);
      ...
      <table class="table table-hover align-middle mb-0" style="font-size: 0.9em;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span class="badge bg-light text-dark border small"><i class="far fa-calendar-alt me-1 text-primary"></i> <?= $p["start_year"] ?> - <?= $r["end_year"] ?? $p["end_year"] ?></span>
            </td>
            ...
            <td class="pe-4 text-end">
              <div class="btn-group">
                <button class="btn btn-outline-secondary btn-sm" title="Edit coming soon"><i class="fas fa-edit"></i></button>
                <form method="POST" class="d-inline" onsubmit="return confirm(\"Delete this PIT provision?\")">
