...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['clear_results'])) {
    $bid = $_POST['batch_id'];
    $pdo->prepare("UPDATE import_sez_data SET benchmark_tax = 0, te_amount = 0, provision_number = NULL, calculated_at = NULL WHERE batch_id = ? AND type = 'Investor'")->execute([$bid]);
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['calculate_batch'])) {
    $bid = $_POST['batch_id'];
    $res = $engine->calculateBatch($bid, 'Investor');
...
$recent = $pdo->query("SELECT batch_id, tax_year, COUNT(*) as `rows`, SUM(te_amount) as total_te, MAX(import_date) as latest, MAX(calculated_at) as last_calc FROM import_sez_data WHERE type='Investor' GROUP BY batch_id, tax_year ORDER BY latest DESC LIMIT 10")->fetchAll();
...
<div class="row mb-3 align-items-center">
    <div class="col-md-7">
        <h2><i class="fas fa-calculator me-2 text-success"></i> SEZ Investor TE</h2>
    ...
    <div class="card shadow-sm border-0 h-100">
      ...
      <div class="card-body p-2">
        ...
        <?php else: ?>
            ...
            <div class="mb-2 p-2 rounded <?= $current_batch == $r['batch_id'] ? 'bg-light border border-success' : 'border' ?>">
                <div class="d-flex justify-content-between align-items-center">
                    <a href="?batch=<?= urlencode($r['batch_id']) ?>" class="small fw-bold text-decoration-none text-success"><?= substr($r['batch_id'], -14) ?> (<?= $r['tax_year'] ?>)</a>
                    <?php if ($r['last_calc']): ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-end">
                        <form method="POST" class="d-inline">
                            ...
                            <button type="submit" name="calculate_batch" class="btn <?= $is_calculated ? 'btn-outline-success' : 'btn-success' ?> shadow-sm">
                    ...
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded border-start border-4 border-primary">
                                <div class="small text-muted text-uppercase fw-bold">Total Utilities/Infra</div>
                    ...
                    <table class="table table-hover table-striped mb-0 align-middle">
                        ...
                        <tbody class="small">
                            ...
                            <tr>
                                ...
                                <td class="text-end text-warning fw-bold"><?= number_format($r['benchmark_tax'], 2) ?></td>
    ...
    <?php else: ?>
        <div class="card shadow-sm border-0 border-top border-4 border-success">
            <div class="card-body p-5 text-center">
                ...
                <a href="import_sez_inv.php" class="btn btn-success text-white mt-3"><i class="fas fa-upload me-2"></i> Go to Import Page</a>
            </div>
        </div>
    <?php endif; ?>
  </div>
