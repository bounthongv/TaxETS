...
<div class="row mb-3">
  <div class="col-12">
    ...
    <p class="text-muted">Part of the System section. Configure global system parameters.</p>
  </div>
</div>
...
<div class="card shadow-sm mt-4">
    <div class="card-body py-5 text-center text-muted">
        ...
        <p>The System Management module is being prepared for upcoming integration.</p>
