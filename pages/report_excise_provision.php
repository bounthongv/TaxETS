...
<div class="row mb-3">
  <div class="col-12">
    <h2><i class="fas fa-list-ul me-2"></i> Excise Tax TE by provision</h2>
    <p class="text-muted">Part of the TE Reports section. Breakdown of excise tax expenditures by legal provision.</p>
  </div>
</div>
