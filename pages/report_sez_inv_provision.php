...
if (isset($_GET['export']) && $_GET['export'] === '1') {
    ...
    $sheet->setCellValue('A1', "SEZ Investor TE by Provision ({$from_year} - {$to_year})");
    ...
    header('Content-Disposition: attachment; filename="TE_SEZ_Inv_by_Provision_' . $from_year . '-' . $to_year . '.xlsx"');
