...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["action"])) {
    try {
        ...
        if ($action === "update_record") {
            ...
            $new_batch = $batch ?: "MANUAL_ENTRY_ROYALTY_" . $manualYear . "_" . date("YmdHis");
...
<div class="row mb-3">
  <div class="col-12 d-flex justify-content-between align-items-center">
    ...
    <div class="btn-group shadow-sm">
      ...
      <a href="te_royalty.php?batch=<?= urlencode($batch) ?>" class="btn btn-danger text-white fw-bold"><i class="fas fa-calculator me-2"></i> Go to TE Calculation</a>
    </div>
  </div>
</div>
...
function goToManualEntry() {
    ...
    window.location.href = `view_royalty.php?batch=MANUAL_ENTRY_ROYALTY_${year}_${stamp}&auto_add=1&year=${year}`;
}
</script>
