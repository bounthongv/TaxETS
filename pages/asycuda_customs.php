...
<div class="row mb-3">
    <div class="col-md-12">
        <h2><i class="fas fa-gavel me-2"></i> ASYCUDA Data: Customs Duty</h2>
        <p class="text-muted">Common fields and Customs Duty benchmark vs paid data.</p>
    </div>
</div>
            ...
            <table class="table table-hover table-sm mb-0 small text-nowrap">
                <thead class="table-light sticky-top">
                    <tr>
                        ...
                        <th>Unit</th>
                        <th>Invoice LAK</th>
                        <th class="table-primary text-center border-start">Exemp_Customs (Benchmark)</th>
                        <th class="table-success text-center border-start">Customs (Paid)</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end fw-bold text-primary border-start"><?= number_format($r['exemp_customs']) ?></td>
                        <td class="text-end fw-bold text-success border-start"><?= number_format($r['paid_customs']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if (empty($rows)): ?>
